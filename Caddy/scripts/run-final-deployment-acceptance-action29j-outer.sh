...
readonly prefix=action_29j_outer
readonly schema_version=action29j-final-acceptance-v2
...
readonly regression=$caddy_root/tests/action29j-final-deployment-acceptance-regression.sh
readonly manifest=$caddy_root/manifests/caddy-final-deployment-acceptance-action29j.yaml
...
readonly expected_regression_sha256=f34c5f57b311b99e4c9044f5d33db51aa861d9b29339d2b0fbfa4d966f399856
evidence_root=${CADDY_ACTION29J_EVIDENCE_ROOT:-/tmp/caddy-ssh-evidence/action29j}
readonly evidence_root
ssh_binary=${CADDY_ACTION29J_SSH_BIN:-/usr/bin/ssh}
readonly ssh_binary
run_id=
work_root=
self_test_root=
