...
readonly runner_sha256=d6156c5d649593806a76a6716f9f5bb807bc695b23ae1b3b300bdb60834e362b
readonly regression_sha256=4b597edb14b50d16270d3a187213f835578ee9b6de68060bdf0056ce57e51ace
...
readonly runner="$script_directory/run-node-a-caddy-vrrp-candidate-diagnostic-action20d-b.sh"
readonly regression="$caddy_root/tests/action20d-b-node-a-candidate-diagnostic-regression.sh"
...
run_local_gates
[[ -z "${CADDY_ACTION20DB_INTERCEPTED_TEST:-}" ]]
work_directory=$(mktemp -d /tmp/caddy-action20d-b-outer.XXXXXX)
