...
readonly regression_sha256=3872e819545fb9e1e6a2900ac83734ca13f3e2b592a749c8b849b0579b305df6
...
readonly runner="$script_directory/run-node-b-caddy-health-postinstall-action20b-a.sh"
readonly regression="$caddy_root/tests/action20b-a-node-b-caddy-health-postinstall-regression.sh"
...
run_local_gates
working_directory_approved
work_directory=$(mktemp -d /tmp/caddy-action20b-a-outer.XXXXXX)
