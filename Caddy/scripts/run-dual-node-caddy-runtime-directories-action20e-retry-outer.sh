...
readonly installer_sha256=36643fcff4505c346d39f8f64a0d90837810a3f7671f79bf5c4e65e80f5f178f
readonly runner_sha256=cf4fde0ab4bc18c77fb14a4b0b44ca9e6619c5e44282f69521ad842c06ad5668
...
readonly runner=$script_directory/run-dual-node-caddy-runtime-directories-action20e-retry.sh
...
run_local_gates
capture_root=$(mktemp -d /tmp/caddy-action20e-retry-outer.XXXXXX)
