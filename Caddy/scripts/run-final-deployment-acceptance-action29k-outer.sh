...
readonly prefix=action_29k_outer
readonly schema_version=action29k-final-acceptance-v2
...
readonly inspector=$script_directory/inspect-final-deployment-action29i.sh
readonly dns_probe=$script_directory/run-dual-node-dns-record-families-action24-retry5-outer.sh
...
readonly regression=$caddy_root/tests/action29k-final-deployment-acceptance-regression.sh
readonly manifest=$caddy_root/manifests/caddy-final-deployment-acceptance-action29k.yaml
readonly expected_inspector_sha256=302be50c7881b7a024eafbc53c4cb4a89c05bd214623194c6d7c49aff9b3c49a
readonly expected_dns_probe_sha256=02c2f539237725add537526dbe989e133e9edb2c8faaf8dddb7e2a752a3016e1
...
readonly expected_regression_sha256=f9de1bbe91705e6238b7fc932276092ed6104a564db558927774c406c7ee2cba
evidence_root=${CADDY_ACTION29K_EVIDENCE_ROOT:-/tmp/caddy-ssh-evidence/action29k}
readonly evidence_root
ssh_binary=${CADDY_ACTION29K_SSH_BIN:-/usr/bin/ssh}
readonly ssh_binary
run_id=
work_root=
self_test_root=
...
require_regex_one() {
    local action29i_outer_pattern=$1
    local action29i_outer_file=$2

    [[ "$(grep -Exc "$action29i_outer_pattern" "$action29i_outer_file")" -eq 1 ]]
}
validate_node_transcript() {
    ...
    while IFS= read -r action29_outer_label; do
        require_one "action_29i_remote_${action29_outer_token}_check_${action29_outer_label}=true" "$action29_outer_stdout" || return 1
    done < <(/bin/bash "$inspector" --expected-checks "$action29_outer_role")
    ! grep -Eq '^action_29i_remote_.*_check_.*=false$' "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_schema=action29i-node-snapshot-v2" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_expected_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_observed_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_expected_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_observed_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_expected_manifest_sha256=5c2fad1133a2fae7ec37253bf1ecadb5971c949a8dc197b4dc7083d20cca6494" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_observed_manifest_sha256=5c2fad1133a2fae7ec37253bf1ecadb5971c949a8dc197b4dc7083d20cca6494" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_observed_manifest_paths_status=0" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_observed_manifest_file_set_status=0" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_status=0" "$action29_outer_stdout" || return 1
    require_regex_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stdout_bytes=[0-9]+" "$action29_outer_stdout" || return 1
    require_regex_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stdout_lines=[1-9][0-9]*" "$action29_outer_stdout" || return 1
    require_regex_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stdout_sha256=[0-9a-f]{64}" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stdout_classification=bounded_safe" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stdout_begin" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stdout_end" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stderr_bytes=0" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stderr_lines=0" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stderr_sha256=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stderr_classification=bounded_safe" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_manifest_hash_check_stderr_content=empty" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_first_failure=none" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_read_only=true" "$action29_outer_stdout" || return 1
    require_one "action_29i_remote_${action29_outer_token}_complete=true" "$action29_outer_stdout" || return 1
