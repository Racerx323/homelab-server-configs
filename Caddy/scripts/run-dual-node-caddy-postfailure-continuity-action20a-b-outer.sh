...
readonly regression_sha256=0d99ca41afe7e388fe7c623e9c55b1d932221c19af1ec108b31f54746216c5f8
...
readonly runner="$script_directory/run-dual-node-caddy-postfailure-continuity-action20a-b.sh"
readonly regression="$caddy_root/tests/action20a-b-dual-node-postfailure-continuity-regression.sh"
...
[[ -z "${CADDY_ACTION20AB_INTERCEPTED_TEST:-}" ]]
work_directory=$(mktemp -d /tmp/caddy-action20ab-outer.XXXXXX)
