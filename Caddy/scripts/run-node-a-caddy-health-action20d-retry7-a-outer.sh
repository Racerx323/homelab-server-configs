...
readonly runner_sha256=1695de99fef1d33a704481289ba80fb5f479a00540052e0f480fd40f943462fa
...
readonly runner="$script_directory/run-node-a-caddy-health-action20d-retry7-a.sh"
readonly regression="$caddy_root/tests/action20d-retry7-a-caddy-health-regression.sh"
...
run_local_gates
[[ -z "${CADDY_ACTION20D_RETRY7_A_INTERCEPTED_TEST:-}" ]]
work_directory=$(mktemp -d /tmp/caddy-action20d-retry7-a-outer.XXXXXX)
