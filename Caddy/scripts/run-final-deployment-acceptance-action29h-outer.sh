...
readonly prefix=action_29h_outer
readonly schema_version=action29h-final-acceptance-v2
...
readonly inspector=$script_directory/inspect-final-deployment-action29h.sh
readonly dns_probe=$script_directory/run-dual-node-dns-record-families-action24-retry3-outer.sh
...
readonly regression=$caddy_root/tests/action29h-final-deployment-acceptance-regression.sh
readonly manifest=$caddy_root/manifests/caddy-final-deployment-acceptance-action29h.yaml
readonly expected_inspector_sha256=57d83d72328e7545e49046512f9c123d7811d9af66dec2d3a718f5d19aa82893
readonly expected_dns_probe_sha256=dc58df1e3c5d4ea9bbd68111d941d890cb6ed4c2e4cd8a5785887b91562b2d2a
...
readonly expected_regression_sha256=a9be0a4edff7e144d69951a3394e6b6cc681dfb76724c09fca10f4a7f53ac78b
evidence_root=${CADDY_ACTION29F_EVIDENCE_ROOT:-/tmp/caddy-ssh-evidence/action29h}
...
require_regex_one() {
    local action29h_outer_pattern=$1
    local action29h_outer_file=$2

    [[ "$(grep -Exc "$action29h_outer_pattern" "$action29h_outer_file")" -eq 1 ]]
}
validate_node_transcript() {
    ...
    while IFS= read -r action29_outer_label; do
        require_one "action_29h_remote_${action29_outer_token}_check_${action29_outer_label}=true" "$action29_outer_stdout" || return 1
    done < <(/bin/bash "$inspector" --expected-checks "$action29_outer_role")
    ! grep -Eq '^action_29h_remote_.*_check_.*=false$' "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_schema=action29h-node-snapshot-v2" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_expected_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_observed_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_expected_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_observed_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_expected_manifest_sha256=5c2fad1133a2fae7ec37253bf1ecadb5971c949a8dc197b4dc7083d20cca6494" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_observed_manifest_sha256=5c2fad1133a2fae7ec37253bf1ecadb5971c949a8dc197b4dc7083d20cca6494" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_observed_manifest_paths_status=0" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_observed_manifest_file_set_status=0" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_status=0" "$action29_outer_stdout" || return 1
    require_regex_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stdout_bytes=[0-9]+" "$action29_outer_stdout" || return 1
    require_regex_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stdout_lines=[1-9][0-9]*" "$action29_outer_stdout" || return 1
    require_regex_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stdout_sha256=[0-9a-f]{64}" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stdout_classification=bounded_safe" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stdout_begin" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stdout_end" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stderr_bytes=0" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stderr_lines=0" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stderr_sha256=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stderr_classification=bounded_safe" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_manifest_hash_check_stderr_content=empty" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_first_failure=none" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_read_only=true" "$action29_outer_stdout" || return 1
    require_one "action_29h_remote_${action29_outer_token}_complete=true" "$action29_outer_stdout" || return 1
