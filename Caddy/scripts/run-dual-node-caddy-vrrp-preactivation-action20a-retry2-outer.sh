...
readonly regression_sha256=58a02d73216a847b344281f1a87a57cd373a5613c26ba59eebf4838acdcd57af
...
readonly runner="$script_directory/run-dual-node-caddy-vrrp-preactivation-action20a-retry2.sh"
readonly regression="$caddy_root/tests/action20a-retry2-dual-node-caddy-vrrp-preactivation-regression.sh"
...
[[ -z "${CADDY_ACTION20ARETRY2_INTERCEPTED_TEST:-}" ]]
work_directory=$(mktemp -d /tmp/caddy-action20a-retry2-outer.XXXXXX)
