...
readonly runner_sha256=acbfc9f02f1e70d1987afee7c6e8e7c4e9c2a533860af0cf6268293c2ef76c82
readonly regression_sha256=5c45626f2441252ab33863738902614bda3f3317db627a9a3124d9efbef32714
...
readonly runner="$script_directory/run-dual-node-caddy-vrrp-activation-action20d-retry.sh"
readonly regression="$caddy_root/tests/action20d-retry-dual-node-caddy-vrrp-activation-regression.sh"
...
[[ -z "${CADDY_ACTION20D_RETRY_SSH_BINARY:-}" ]]
outer_work=$(mktemp -d /tmp/caddy-action20d-retry-outer.XXXXXX)
readonly outer_work
