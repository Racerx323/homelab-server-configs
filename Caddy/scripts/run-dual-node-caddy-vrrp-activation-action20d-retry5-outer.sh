...
readonly prefix=action_20d_retry5
...
readonly regression_sha256=88ae997a24084e050a668f5005e76498cbd9d5c4cd9066d48ce05ae15b0b3ccf
...
readonly regression=$caddy_root/tests/action20d-retry5-activation-boundary-regression.sh
...
run_boundary() {
    ...
    boundary_root=$(mktemp -d /tmp/caddy-action20d-retry5-boundary.XXXXXX)
