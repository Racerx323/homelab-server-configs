...
readonly regression_sha256=059a2a35b013c8569d66b24a02514f4e8eecf738d2ec578bf0233ab1f4bd842f
...
readonly inspector="$script_directory/inspect-node-a-caddy-health-postinstall-action20c-a.sh"
readonly runner="$script_directory/run-node-a-caddy-health-postinstall-action20c-a.sh"
readonly regression="$caddy_root/tests/action20c-a-node-a-caddy-health-postinstall-regression.sh"
...
run_local_gates
working_directory_approved
work_directory=$(mktemp -d /tmp/caddy-action20c-a-outer.XXXXXX)
