...
readonly regression_sha256=637c09c66b7d3b17a1cced6fdd2557973bb8195e9688fc66c08d0621170ea9e3
readonly rendered_inspector_sha256=20639a8f1a70c3034aa516c765239399f9103ba7c06c79a8e1aee17a713b04a1
readonly rendered_runner_sha256=ca0d15355bd30a4f90ec6a177a33967822af840ddf85ea30c4ad46c12472ebd2
...
readonly derivation="$script_directory/derive-node-a-keepalived-fragment-postinstall-action19e-a.sh"
readonly regression="$caddy_root/tests/action19e-a-node-a-keepalived-fragment-postinstall-regression.sh"
...
render_stage() {
    ...
    local staged_inspector=$stage_scripts/inspect-node-a-keepalived-fragment-postinstall-action19e-a.sh
    local staged_runner=$stage_scripts/run-node-a-keepalived-fragment-postinstall-action19e-a.sh
...
case "${1:-}" in
    --self-test | --source-test | --contract-test)
        [[ $# -eq 1 ]] || exit 64
        test_root=$(mktemp -d /tmp/caddy-action19e-a-outer-test.XXXXXX)
        readonly test_root
...
work_directory=$(mktemp -d /tmp/caddy-action19e-a-outer.XXXXXX)
