...
readonly regression_sha256=5a472919220e3c90688bdbc43701b170f9c0426f68dea4b53395a556b20b7a6f
...
readonly runner="$script_directory/run-dual-node-caddy-health-context-action20a-a.sh"
readonly regression="$caddy_root/tests/action20a-a-dual-node-caddy-health-context-regression.sh"
...
[[ -z "${CADDY_ACTION20AA_INTERCEPTED_TEST:-}" ]]
work_directory=$(mktemp -d /tmp/caddy-action20aa-outer.XXXXXX)
