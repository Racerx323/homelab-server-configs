...
readonly prefix=action_29c_outer
readonly schema_version=action29c-final-acceptance-v2
...
readonly inspector=$script_directory/inspect-final-deployment-action29c.sh
...
readonly regression=$caddy_root/tests/action29c-final-deployment-acceptance-regression.sh
readonly manifest=$caddy_root/manifests/caddy-final-deployment-acceptance-action29c.yaml
readonly expected_inspector_sha256=d364955ec715eb7b780c4443be88245bf558d06f78208e133bd8bb95d3577d14
...
readonly expected_regression_sha256=716f7e034601d6bc3f500ee94f4dffa9622fa304fe96883842e30eca5055ab7b
evidence_root=${CADDY_ACTION29C_EVIDENCE_ROOT:-/tmp/caddy-ssh-evidence/action29c}
...
validate_node_transcript() {
    ...
    while IFS= read -r action29_outer_label; do
        require_one "action_29c_remote_${action29_outer_token}_check_${action29_outer_label}=true" "$action29_outer_stdout" || return 1
    done < <(/bin/bash "$inspector" --expected-checks "$action29_outer_role")
    ! grep -Eq '^action_29c_remote_.*_check_.*=false$' "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_schema=action29c-node-snapshot-v2" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_expected_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_observed_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_expected_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_observed_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_first_failure=none" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_read_only=true" "$action29_outer_stdout" || return 1
    require_one "action_29c_remote_${action29_outer_token}_complete=true" "$action29_outer_stdout" || return 1
