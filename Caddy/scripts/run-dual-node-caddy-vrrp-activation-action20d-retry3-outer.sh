...
readonly prefix=action_20d_retry3
readonly complete_suite_sha256=aba6f8bea4c0a5247cfa08bacf4e85e6dd3b92126dbf69be6f360ed36465bbd2
readonly integration_suite_sha256=cc1aa4e8873d680fbf144a51eceae921c6b56dd25d534edacde276fadcc8ff8e
readonly correction_boundary_sha256=4cceb2ad94442beb4e24ea5054ca6172e0392f795b8ad0885c629796ddac121c
...
readonly regression_sha256=e7a70d9dceb12a9f02de7e8f6e42e69085dd81d11b70d3627696589777c17751
...
readonly correction_boundary=$caddy_root/tests/action17q-umask-stable-boundary.sh
...
readonly regression=$caddy_root/tests/action20d-retry3-activation-boundary-regression.sh
...
correction_wiring_exact() {
    # The dollar-prefixed name is literal suite source.
    # shellcheck disable=SC2016
    local expected_call='"$caddy_root/tests/action17q-umask-stable-boundary.sh"'
    ...
    ! grep -Fq '"$caddy_root/tests/action17q-retry-node-b-protocol-v2-install-regression.sh"' \
        "$complete_suite" "$integration_suite"
}
...
run_local_gates() {
    ...
    run_gate correction_boundary_self_test /bin/bash "$correction_boundary" --self-test || return 1
...
run_boundary() {
    ...
    boundary_root=$(mktemp -d /tmp/caddy-action20d-retry3-boundary.XXXXXX)
...
case "${1:-}" in
    --expected-local-gates)
        ...
        printf '%s\n' working_directory complete_suite_hash integration_suite_hash \
            ...
            output_evidence_policy correction_boundary_self_test \
