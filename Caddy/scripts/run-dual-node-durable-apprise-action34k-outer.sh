...
readonly prefix=action_34k_outer
...
readonly action_transaction=$script_directory/apply-durable-apprise-action34k.sh
readonly regression=$caddy_root/tests/durable-apprise-deployment-regression.sh
readonly artifact_manifest=$caddy_root/manifests/durable-apprise-action34k.tsv
readonly runtime_baseline_manifest=$caddy_root/manifests/caddy-runtime-lifecycle-action32g.tsv
readonly action_manifest=$caddy_root/manifests/durable-apprise-action34k.yaml
readonly expected_upload_transaction_sha256=34d43af6e72bcb40826eb8510cfe0a2d11369f8b7ec94529772e47217505675f
readonly expected_action_transaction_sha256=4bd8df19ab7f75870b0993259503eea1192eb26a9f5ddebbd7b3732c5cc39920
readonly expected_regression_sha256=56266054495509deeb6d70e9378f2589ae1b69385571625611807d2e1b0db9c2
...
readonly evidence_root=/tmp/caddy-ssh-evidence/action34k
...
build_payload() {
    ...
    install -m 0600 "$artifact_manifest" \
        "$action34i_outer_payload_root/Caddy/manifests/durable-apprise-action34k.tsv" || return 1
    ...
    payload_archive=$work_root/caddy-action34k-payload.tar
...
run_local_gates() {
    ...
    gate deployable_successor_policy \
        /bin/bash Caddy/tests/deployable-successor-policy.sh --check || return 1
...
run_action() {
    ...
    node_b_remote_payload=/tmp/caddy-action34k-payload-node-b-$run_token.tar
    node_a_remote_payload=/tmp/caddy-action34k-payload-node-a-$run_token.tar
