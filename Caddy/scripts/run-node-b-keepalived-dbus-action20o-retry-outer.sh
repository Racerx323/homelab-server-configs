...
readonly prefix=action_20o_retry_outer
...
readonly transaction=$script_directory/activate-node-b-keepalived-dbus-action20o-retry.sh
readonly regression=$caddy_root/tests/action20o-retry-node-b-keepalived-dbus-regression.sh
