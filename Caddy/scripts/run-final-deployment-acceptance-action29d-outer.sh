...
readonly prefix=action_29d_outer
readonly schema_version=action29d-final-acceptance-v2
...
readonly inspector=$script_directory/inspect-final-deployment-action29d.sh
...
readonly regression=$caddy_root/tests/action29d-final-deployment-acceptance-regression.sh
readonly manifest=$caddy_root/manifests/caddy-final-deployment-acceptance-action29d.yaml
readonly expected_inspector_sha256=6508b7474db8afa07e131fbe89db08f74082976ab15d9fac576a6a1340555e33
...
readonly expected_regression_sha256=62a8059f4f095991a18dcba62b686d0a24c2232c6117d9d494c2b53b4da15d74
evidence_root=${CADDY_ACTION29C_EVIDENCE_ROOT:-/tmp/caddy-ssh-evidence/action29d}
readonly evidence_root
ssh_binary=${CADDY_ACTION29C_SSH_BIN:-/usr/bin/ssh}
readonly ssh_binary
run_id=
work_root=
self_test_root=
...
require_regex_one() {
    local action29d_outer_pattern=$1
    local action29d_outer_file=$2

    [[ "$(grep -Exc "$action29d_outer_pattern" "$action29d_outer_file")" -eq 1 ]]
}
validate_node_transcript() {
    ...
    while IFS= read -r action29_outer_label; do
        require_one "action_29d_remote_${action29_outer_token}_check_${action29_outer_label}=true" "$action29_outer_stdout" || return 1
    done < <(/bin/bash "$inspector" --expected-checks "$action29_outer_role")
    ! grep -Eq '^action_29d_remote_.*_check_.*=false$' "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_schema=action29d-node-snapshot-v2" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_expected_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_observed_pihole_ftl_sha256=a1dc88b1f696a6870e38025be113ff8664750fca6265c79a2aee12f80898cfa3" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_expected_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_observed_pihole_domain_sha256=39fa219a7d1c81c7fb36d89bc17ba1caae26f3472eb861a750a8ba03ae55b026" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_expected_manifest_sha256=fdc6ed955f14226ac3e1777eca37507cc8ab6ca16add3135dece9d6964e27568" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_observed_manifest_sha256=fdc6ed955f14226ac3e1777eca37507cc8ab6ca16add3135dece9d6964e27568" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_status=0" "$action29_outer_stdout" || return 1
    require_regex_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stdout_bytes=[0-9]+" "$action29_outer_stdout" || return 1
    require_regex_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stdout_lines=[1-9][0-9]*" "$action29_outer_stdout" || return 1
    require_regex_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stdout_sha256=[0-9a-f]{64}" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stdout_classification=bounded_safe" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stdout_begin" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stdout_end" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stderr_bytes=0" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stderr_lines=0" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stderr_sha256=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stderr_classification=bounded_safe" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_manifest_hash_check_stderr_content=empty" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_first_failure=none" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_read_only=true" "$action29_outer_stdout" || return 1
    require_one "action_29d_remote_${action29_outer_token}_complete=true" "$action29_outer_stdout" || return 1
