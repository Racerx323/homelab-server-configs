...
readonly installer_sha256=f8a138085e74e264f2b450e9d90ec6cf0fce25f2cbf6d878097cf00caa1cc8ab
readonly runner_sha256=6af6df0054d312e6f34843be5e5f3ab5edc6a11d58e647eed40111d1133f54b7
...
readonly runner=$script_directory/run-dual-node-caddy-runtime-directories-action20e.sh
...
run_local_gates
capture_root=$(mktemp -d /tmp/caddy-action20e-outer.XXXXXX)
