...
readonly prefix=action_29i_outer
readonly schema_version=action29i-final-acceptance-v2
...
readonly dns_probe=$script_directory/run-dual-node-dns-record-families-action24-retry4-outer.sh
...
readonly regression=$caddy_root/tests/action29i-final-deployment-acceptance-regression.sh
...
readonly expected_dns_probe_sha256=bf27b488b6f081936282955b10e7e0d4b7db578bdf43d4661fb83acfef50213a
...
readonly expected_regression_sha256=2b2962fbd80dfbc9288bb03729eedb95186f65da0003d4a1e0e307ff8c131ace
evidence_root=${CADDY_ACTION29F_EVIDENCE_ROOT:-/tmp/caddy-ssh-evidence/action29i}
