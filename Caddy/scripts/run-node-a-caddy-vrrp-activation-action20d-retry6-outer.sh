...
readonly activation_outer_sha256=aae2c5aa245a5a39e067ddc4c47333d4e72516b35f09ee8d221f9fa101de36bf
readonly regression_sha256=cc99b0fe150098e38b50685ea859eed7a1f0eb77031a6317d5b83d23685e00ac
...
readonly activation_outer=$script_directory/run-node-a-caddy-vrrp-activation-action20d-retry6.sh
readonly regression=$caddy_root/tests/action20d-retry6-activation-boundary-regression.sh
...
run_boundary() {
    ...
    boundary_root=$(mktemp -d /tmp/caddy-action20d-retry6-boundary.XXXXXX)
