...
readonly runner_sha256=bed2a3de28de867afdc9c2ee32212a85111209e0b4f5acbe23c25d4fb702ef40
readonly regression_sha256=5667c2a895d5958b3c0d8ec7c4a92a666a74fd42e4f67bac35b79e2c092a5b2d
...
readonly runner="$script_directory/run-node-b-caddy-health-context-correction-action20b.sh"
readonly regression="$caddy_root/tests/action20b-node-b-caddy-health-context-correction-regression.sh"
...
run_local_gates
working_directory_approved
work_directory=$(mktemp -d /tmp/caddy-action20b-outer.XXXXXX)
