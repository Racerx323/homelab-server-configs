...
readonly readiness_outer_sha256=c62dd274363107d45a0cbe4735c6da590f20a15455c9243d4c37e65f71ba1792
readonly activation_outer_sha256=6209d5e412280e26e1a86b9d689d5ece45c7dfec61162a56aed7a5db6027e5a4
readonly regression_sha256=ebbf26d44c418674ae8d13a128071770b4a27f9711f12c5c9fbbdf237a38f189
...
readonly readiness_outer=$script_directory/run-dual-node-caddy-readiness-action20d-retry9.sh
readonly activation_outer=$script_directory/run-node-a-caddy-vrrp-activation-action20d-retry9.sh
readonly regression=$caddy_root/tests/action20d-retry9-activation-boundary-regression.sh
...
run_boundary() {
    ...
    boundary_root=$(mktemp -d /tmp/caddy-action20d-retry9-boundary.XXXXXX)
