...
readonly regression=$script_directory/action20o-a-node-b-postrollback-regression.sh
...
printf '%s\n' \
    action_20o_a_focused_node_b_contacted=false \
    action_20o_a_focused_node_a_contacted=false \
    action_20o_a_focused_reload=false \
    action_20o_a_focused_correction=false \
    action_20o_a_focused_complete=true
