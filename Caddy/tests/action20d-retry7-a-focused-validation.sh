...
readonly prefix=action_20d_retry7_a_focused
readonly diagnostic_sha256=454055695f135c72277808e5cc1902e0c4a15620fe967a3f8aa04e14dedbcd1f
readonly outer_sha256=afabeba6e9fb9a80155c63d47ddee223c258cd0e1b6eeaff6c8ce2a9ff6a19e0
readonly regression_sha256=b03da274a0d98c5136b059caeb0f9e9efc7c82aa944b2d111b5250a369d9437d

test_directory=$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)
readonly test_directory
readonly caddy_root=${test_directory%/tests}
readonly diagnostic=$caddy_root/scripts/diagnose-node-a-caddy-health-action20d-retry7-a.sh
readonly outer=$caddy_root/scripts/run-node-a-caddy-health-action20d-retry7-a-outer.sh
readonly regression=$test_directory/action20d-retry7-a-caddy-health-regression.sh
