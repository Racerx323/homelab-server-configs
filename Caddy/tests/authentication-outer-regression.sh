...
for auth_outer_scenario in success login-failure restore-failure interrupt-helper evidence-failure dns-failure publish-reply-failure reconcile-failure reordered-evidence; do
