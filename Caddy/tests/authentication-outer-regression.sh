...
for auth_outer_scenario in preflight-ipv6 preflight-tls preflight-http preflight-service preflight-interrupt success login-failure restore-failure interrupt-helper evidence-failure dns-failure publish-reply-failure reconcile-failure reordered-evidence; do
