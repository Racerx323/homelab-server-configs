...
for auth_outer_scenario in preflight-baseline-changed preflight-baseline-missing preflight-baseline-extra preflight-ipv6 preflight-tls preflight-http preflight-service preflight-publication preflight-interrupt success login-failure shared-login-failure restore-failure interrupt-helper evidence-failure dns-failure activate-reply-failure reconcile-failure reordered-evidence; do
