...
Stage 5, administrator bootstrap, production deployment, isolated canary restore
and application backup/recovery remain open. Repository initialization and
canary upload/integrity are accepted.
