...
| `backblaze-b2-replacement-key-creation-v1` | Completed by operator after the API client received HTTP 500; canonical credential passed read-only v4 authentication and exact-scope validation, with Restic acceptance pending | `backblaze-b2-replacement-key-creation-v1-completed-operator-recovery` | `4dcc376bf24e9e343718c26596b6c9beac055429` | `049e7292b429d03cf79ef9e24c1e24533d033c4eb64e88b2aec5864a732b0bbd` |
