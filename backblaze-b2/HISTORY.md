...
| `backblaze-b2-replacement-key-creation-v1` | Completed by operator after the API client received HTTP 500; canonical credential passed read-only v4 authentication and exact-scope validation, then the operator deleted the original key before Restic acceptance | `backblaze-b2-replacement-key-creation-v1-completed-operator-recovery` | `4dcc376bf24e9e343718c26596b6c9beac055429` | `049e7292b429d03cf79ef9e24c1e24533d033c4eb64e88b2aec5864a732b0bbd` |
| `backblaze-b2-s3-compatibility-v1` | Completed; exact generated-object transaction and final absence verification passed without residue | `backblaze-b2-s3-compatibility-v1-completed` | `c5935852e1a5089fddd6b23eda5ab8e44d2e4422` | `20f1b43840e877c60248fc7dc06525d29124cc78ebcbd8ac8af3648340e39588` |
